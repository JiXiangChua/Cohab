       ...
       <Modal
        ...
        onRequestClose={() => {
          setRestoreVisible(!restoreVisible);}}>
                ...
                <BasicText style={{paddingTop:30, paddingBottom: 10, textAlign: "center"}}>Choose a Date: </BasicText>
                <View
                              style={{
                    ...
                    <View style={{marginTop: 10 , paddingRight: 10}}>
                        <BorderColorButton buttonText={"Cancel"} color={"#7B98FF"} onPress={() => setRestoreVisible(!restoreVisible)}/>
                    </View>

                    <View style={{marginTop: 10 }}>
                        <GeneralButton buttonText={"Add Entry"} color={"#36BC7C"} onPress={() => setRestoreVisible(!restoreVisible)}/>
                    </View>
                </View>
